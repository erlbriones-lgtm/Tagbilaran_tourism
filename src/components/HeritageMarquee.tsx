...
const row1Cards: MarqueeCardProps[] = [
  ...
  },
  {
    ...
    district: "Poblacion",
    image: "/HERITAGES/reyes-house/Reyes House 1.webp",
  ...
  },
  {
    ...
    image: "/HERITAGES/friendship-park-abueva/Blood Compact Shrine (31).webp",
...
const row2Cards: MarqueeCardProps[] = [
  {
    ...
    district: "Poblacion",
    image: "/HERITAGES/balili-house-oasis-lodge/Balili Heritage House (1).webp",
  ...
  },
  {
    ...
    category: "Ancestral House",
    district: "Sitio Ubos",
    image: "/HERITAGES/rocha-suarez-house/rocha-suarez 1.webp",
